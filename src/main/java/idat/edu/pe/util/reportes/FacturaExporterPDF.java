...
public class FacturaExporterPDF {
	...
	public FacturaExporterPDF(Cabezera venta) {
	...
	// Crea la Cabecera de la tabla
			...
			public void exportar(HttpServletResponse response) throws DocumentException, IOException {
			    ...
			    String RUC = 		  " RUC             : " + venta.getNumeroDoc();
			    String nombre = 	  " Razón Social    : " + venta.getNombre();
			    ...
			    cb2.showTextAligned(Element.ALIGN_LEFT, RUC, 36, 650, 0);
